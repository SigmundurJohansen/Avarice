...
namespace Avarice
{
    ...
    inline VertexInputDescription GetVertexDescription()
    {
        ...
        // Vertex attributes
        // Position
        description.attributes.push_back({.location = 0,
                                          .binding = 0,
                                          .format = VK_FORMAT_R32G32B32_SFLOAT,
                                          .offset = static_cast<uint32_t>(offsetof(Vertex, position))});

        // Color
        description.attributes.push_back({.location = 1,
                                          .binding = 0,
                                          .format = VK_FORMAT_R32G32B32A32_SFLOAT,
                                          .offset = static_cast<uint32_t>(offsetof(Vertex, color))});

        // uv
        description.attributes.push_back({.location = 2,
                                          .binding = 0,
                                          .format = VK_FORMAT_R32G32_SFLOAT,
                                          .offset = static_cast<uint32_t>(offsetof(Vertex, uv))});

        // normal
        description.attributes.push_back({.location = 3,
                                          .binding = 0,
                                          .format = VK_FORMAT_R32G32B32_SFLOAT,
