...
namespace Avarice
{
  ...
  VulkanRenderer::VulkanRenderer(VulkanDevice &_device)
      : device{_device}
  {
    RecreateSwapChain();
  ...
  void VulkanRenderer::RecreateSwapChain()
  {
    ...
    {
      swapChain = std::make_unique<VulkanSwapChain>(device, ServiceLocator::GetWindow()->GetWindowExtents());
    }
    else
    {
      std::shared_ptr<VulkanSwapChain> oldSwapChain = std::move(swapChain);
      swapChain = std::make_unique<VulkanSwapChain>(device, ServiceLocator::GetWindow()->GetWindowExtents(), oldSwapChain);
